...
public class MediaDAO implements Map<MediaKey, Media> {
    ...
    public Map<String, String> categoriasByUtilizador(String nomeMedia, String artista) {
        ...
        try {
            ...
            ResultSet rs = stm.executeQuery("SELECT * FROM Utilizador_Media " +
    ...
    public int size() {
        ...
        try {
            ...
            int i = 0;
            Statement stm = conn.createStatement();
            ResultSet rs = stm.executeQuery("SELECT nomeMedia FROM Media");
            while (rs.next()) i++;
            return i;
        } catch (Exception e) {
            throw new NullPointerException(e.getMessage());
    ...
    public boolean isEmpty() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT nomeMedia FROM Media");
            return !rs.next();
        } catch (SQLException e) {
            throw new NullPointerException(e.getMessage());
        } finally {
    ...
    public boolean containsKey(Object key) throws NullPointerException {
        ...
        try {
            ...
            String sql = "SELECT nomeMedia FROM Media " +
    ...
    public Media put(MediaKey key, Media value) {
        ...
        try {
            conn = DriverManager.getConnection(url);
            Statement stm = conn.createStatement();
            stm.executeUpdate("DELETE FROM Media  " +
    ...
    public void clear() {
        ...
        try {
            ...
            st.executeUpdate("DELETE FROM Media");
        } catch (Exception e) {
            throw new NullPointerException(e.getMessage());
        } finally {
            if (conn != null)

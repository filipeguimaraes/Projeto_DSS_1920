...
public class BibliotecaDAO implements Map<String, Biblioteca> {
    ...
    public int size() {
        ...
        try {
            ...
            int i = 0;
            Statement stm = conn.createStatement();
            ResultSet rs = stm.executeQuery("SELECT COUNT(*) FROM Biblioteca");
    ...
    public boolean isEmpty() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT cod FROM Biblioteca");
            return !rs.next();
        } catch (Exception e) {
            throw new NullPointerException(e.getMessage());
        } finally {
    ...
    public boolean containsKey(Object key) throws NullPointerException {
        ...
        try {
            con = DriverManager.getConnection(url);
            Statement st = con.createStatement();
            String sql = "SELECT cod FROM Biblioteca " +
                    "where cod='" + key + "' ";
    ...
    public Biblioteca put(String key, Biblioteca value) {
        ...
        try {
            conn = DriverManager.getConnection(url);
            Statement stm = conn.createStatement();
            stm.executeUpdate("DELETE FROM Biblioteca " +
                    "where cod='" + key + "'");

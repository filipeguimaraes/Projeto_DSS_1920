        ...
        try {
            ...
            if (model.eAdmin()) {
                ...
                Scene admin = new Scene(FXMLLoader.load(getClass()
                        .getResource("/views/CreateAccount.fxml")));
                admin.getStylesheets().add(getClass().getResource("/sheet.css").toExternalForm());
                ...
                Scene user = new Scene(FXMLLoader.load(getClass()
                        .getResource("/views/MainPage.fxml")));
                user.getStylesheets().add(getClass().getResource("/sheet.css").toExternalForm());
